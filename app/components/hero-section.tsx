...
export default function HeroSection() {
  return (
    <>
      <main className="overflow-hidden bg-gradient-to-b from-transparent via-indigo-50 to-transparent">
        <section className="relative">
          <div className="relative py-24 lg:py-16">
            <div className="mx-auto max-w-7xl px-6 md:px-12">
              {/* <div className="x-auto relative mx-auto max-w-lg mb-8">
              ...
              <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                <Link
                  to="/"
                  className="bg-background group relative mx-auto flex w-fit items-center justify-center gap-2 overflow-hidden rounded-full border px-2 py-1 text-sm font-medium backdrop-blur-md transition-all duration-300 ease-out hover:cursor-pointer"
                >
                ...
                <h1 className="mt-8 text-4xl font-semibold md:text-5xl xl:text-5xl xl:[line-height:1.125]">
                  Riyadh El-Jannah <br /> Islamic School
                </h1>
                <p className="mx-auto mt-8 hidden max-w-2xl text-wrap text-lg sm:block">
                  Lembaga Pendidikan Islam yang mengintegrasikan nilai-nilai
                  Universal Islam ke dalam semua aspek proses pendidikan dengan
                  mengutamakan penguasaan bekal kehidupan masa depan dalam
                  mempersiapkan generasi bangsa yang berkualitas unggul dalam
                  tatanan Akhlaqul Karimah.
                </p>
                <p className="mx-auto mt-6 max-w-2xl text-wrap sm:hidden">
                  Lembaga Pendidikan Islam terkemuka yang memadukan kurikulum
                  diknas dan pesantren untuk membentuk generasi yang beriman dan
                  berilmu.
                </p>
